...
const PATHS = {
  ...
  eyeOff: '<path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/><path d="M4 4l16 16"/>',
  ...
  // нарисованное этим набором. Сама шестерёнка — контур Feather Icons
  // (MIT), а не нарисованная от руки: свободная и широко проверенная
  // форма, риск кривых пропорций от руки для зубчатого круга был бы
  // куда выше, чем у прямых линий/кружков (первая версия), но по
  // смыслу зубчатый круг подходит лучше.
