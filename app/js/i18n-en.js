...
export const EN_DICT = {
  ...
  "Экспортировать мир как сайт": "Export world as a site",
  "Настройки → Оформление": "Settings → Appearance",
  "Настройки → Шаблоны анкет": "Settings → Form templates",
  "Настройки → Горячие клавиши": "Settings → Keyboard shortcuts",
  ...
  "Изменить отображаемый текст…": "Change display text…",
  "Как показывать «{name}» в тексте:": "How to show \"{name}\" in the text:",
  ...
  // ── Найдено сканером недостающих переводов (avatars/board/canvas/
  // chapter-status/characters/data-panel/entity-sheet/family-tree/
  // manuscript/relationships/settings-panel/stats/templates/visibility) ──
  "Предыдущее изображение": "Previous image",
  "Следующее изображение": "Next image",
  "Изображения": "Images",
  "Открыть в полный размер": "Open full size",
  "Удалить изображение": "Remove image",
  "Добавить изображение": "Add image",

  "Доска 1": "Board 1",
  "Новая доска": "New board",
  "Удалить эту доску навсегда": "Delete this board permanently",
  "Переключить доску": "Switch board",
  "Цвет метки": "Label color",
  "Связать с персонажем": "Link to a character",
  "Связать с фракцией": "Link to a faction",
  ...
  "Удалить статус навсегда": "Delete status permanently",
  ...
  "Холст": "Canvas",
  "Автоочистка старых версий: ": "Auto-clean old versions: ",
  "Удалить этот снимок навсегда": "Delete this snapshot permanently",
  "Экспорт": "Export",
  ...
  "Род {n}": "Lineage {n}",
  "Клик по узлу открывает карточку – родителей назначают там же.": "Click a node to open its card – parents are set there too.",
  "Пока пусто – укажи родителей в карточке персонажа (или добавь нового прямо здесь), чтобы здесь появилось дерево.":
    "Empty for now – set parents on a character's card (or add a new one right here) to grow a tree.",

  "Вставить стикер-заметку": "Insert a sticky note",
  "Размер шрифта: {n}px": "Font size: {n}px",
  "Вырезать": "Cut",
  "Копировать": "Copy",
  "Вставить": "Paste",
  "Выделить всё": "Select all",
  "Слов выделено: {n}": "Words selected: {n}",
  "Слов в главе: {n}": "Words in chapter: {n}",
  "Папка": "Folder",
  "Экспорт главы в .md": "Export chapter as .md",
  "Экспорт главы в .docx": "Export chapter as .docx",
  "Удалить главу": "Delete chapter",
  "Точно удалить главу «{title}»?": "Delete chapter \"{title}\" for good?",
  "Новая подпапка": "New subfolder",
  "Статус папки": "Folder status",
  "Без статуса": "No status",
  "Экспорт папки в .md": "Export folder as .md",
  "Экспорт папки в .docx": "Export folder as .docx",
  "Удалить папку": "Delete folder",
  "Точно удалить папку «{name}» со всем содержимым?": "Delete folder \"{name}\" with everything inside?",
  "Экспорт всей рукописи в .md": "Export the whole manuscript as .md",
  "Экспорт всей рукописи в .docx": "Export the whole manuscript as .docx",
  "Ещё": "More",
  "Заметки и снимки": "Notes and snapshots",
  "Выйти из фокус-режима": "Exit focus mode",
  "Фокус-режим": "Focus mode",
  "Заметки ({n})": "Notes ({n})",
  "Не входят в текст главы и в экспорт.": "Not part of the chapter text or exports.",
  "Удалить заметку": "Delete note",
  "Пока нет – правый клик по тексту главы добавит стикер-заметку.": "None yet – right-click the chapter text to add a sticky note.",
  ...
  "Палитра": "Palette",
  "Сбросить палитру": "Reset palette",
  "Клик – переименовать группу": "Click to rename the group",
  "Убрать подпись группы (пункты останутся, просто без заголовка)": "Remove the group label (items stay, just without a heading)",
  "Без раздела": "Ungrouped",
  "+ Группа": "+ Group",
  "Название группы": "Group name",
  "Перетащи, чтобы изменить порядок": "Drag to reorder",
  "Новый тип тега": "New tag type",
  "Название типа": "Type name",
  "Переименовать тип": "Rename type",
  "+ Шаблон": "+ Template",
  "Новый шаблон – с полями текущего, дальше можно менять независимо": "New template – with the current one's fields, then edit independently",
  "Новый шаблон": "New template",
  "Удалить шаблон (карточки, заведённые по нему, останутся – просто покажут первый оставшийся шаблон)":
    "Delete template (cards created with it stay – they'll just show the first remaining template)",
  "Поле": "Field",
  "Строка": "Single line",
  "Текст в несколько строк": "Multi-line text",
  "Убрать поле из этого шаблона (данные, уже введённые в него у существующих карточек, не стираются)":
    "Remove field from this template (data already entered for existing cards isn't erased)",
  "+ Поле": "+ Field",

  "слов": "words",
  "слов в среднем на главу": "words per chapter on average",
  "Прогресс рукописи": "Manuscript progress",
